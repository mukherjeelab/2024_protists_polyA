...
pdf(here('./figs/R2_drop_glamb.pdf'), width = 4, height = 5)
ggbarplot(r_sq_drop_gl, x = 'term', y = 'explained_variance', fill = 'black',
...
r_sq_drop_gs <- tibble(term = c('full model', 'signal sequence', 'upstream nt', 'downstream nt'),
  ...
  mutate(explained_variance = round(ifelse(term == 'full model', adj_rsq, 
                                           adj_rsq[1] -adj_rsq),digits = 2))
pdf(here('./figs/R2_drop_gsm.pdf'), width = 4, height = 5)
ggbarplot(r_sq_drop_gs, x = 'term', y = 'explained_variance', fill = 'black',
          label = TRUE, lab.col = "white", lab.pos = "in", 
          lab.hjust = 0.5, lab.vjust = 1, lab.size = 5) +
  rremove('xlab') +
  ylab('adjusted R^2') +
...
r_sq_drop_gm <- tibble(term = c('full model', 'signal sequence', 'upstream nt', 'downstream nt'),
  ...
  mutate(explained_variance = round(ifelse(term == 'full model', adj_rsq, 
                                           adj_rsq[1] -adj_rsq),digits = 2))
pdf(here('./figs/fig_elements/R2_drop_gmur.pdf'), width = 4, height = 5)
ggbarplot(r_sq_drop_gm, x = 'term', y = 'explained_variance', fill = 'black',
          label = TRUE, lab.col = "white", lab.pos = "in", 
          lab.hjust = 0.5, lab.vjust = 1, lab.size = 5) +
  rremove('xlab') +
  ylab('adjusted R^2') +
...
r_sq_drop_gm_int <- tibble(term = c('full model', 'signal sequence', 'upstream nt', 'downstream nt'),
  ...
  mutate(explained_variance = round(ifelse(term == 'full model', adj_rsq, 
                                           adj_rsq[1] -adj_rsq),digits = 2))
pdf(here('./figs/R2_drop_gmur_int.pdf'), width = 4, height = 5)
ggbarplot(r_sq_drop_gm_int, x = 'term', y = 'explained_variance', fill = 'black',
          label = TRUE, lab.col = "white", lab.pos = "in", 
          lab.hjust = 0.5, lab.vjust = 1, lab.size = 5) +
  rremove('xlab') +
  ylab('adjusted R^2') +
...
r_sq_drop_all <- rbind(r_sq_drop_gl, r_sq_drop_gs, r_sq_drop_gm) %>%
  mutate(term = factor(term, 
                       levels = c('- downstream nt', '- upstream nt',
                                  '- signal sequence', 'full model')),
         adj_rsq = round(adj_rsq, digits = 2))

pdf(here('./figs/R2_drop_giardia.pdf'), width = 7, height = 4)
ggbarplot(r_sq_drop_all, x = 'term', y = 'adj_rsq', fill = 'black',
          orientation = 'horiz', facet.by = 'dataset', label = TRUE,
          lab.col = "white", lab.pos = "in", lab.hjust = 1, lab.vjust = 0.5) +
  rremove('ylab') +
  ylab('adjusted R^2')
dev.off()
...
pdf(here('./figs/lm_estimates_glamb.pdf'), width = 6, height = 4) 
...
pdf(here('./figs/lm_estimates_gsm.pdf'), width = 6, height = 4) 
...
pdf(here('./figs/lm_estimates_gmur.pdf'), width = 6, height = 4) 
